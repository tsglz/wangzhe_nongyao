...
#include "hero.h" // 引入自定义的头文件，包含Hero结构体的定义

// 定义一个英雄列表，包含多个英雄的名称及其剪刀、石头、布的数量
Hero hero_list[] = {
    {"赵云", 2, 2, 2}, {"宫本武藏", 4, 1, 1}, {"凯", 2, 3, 1}, {"白起", 5, 0, 1}, 
    {"韩信", 1, 2, 3}, {"诸葛亮", 2, 1, 3}, {"刘邦", 2, 0, 4},
    {"后羿", 0, 3, 3}, {"王昭君", 1, 1, 4}, {"妲己", 4, 1, 1}, 
    {"安琪拉", 1, 4, 1}, {"貂蝉", 3, 2, 1}, {"露娜", 1, 3, 2}, 
    {"不知火舞", 4, 2, 0}, {"蔡文姬", 0, 5, 1}
};
